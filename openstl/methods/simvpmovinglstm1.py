...
from openstl.models.simvp_modelmovinglstm1 import SimVP_Modelmovinglstm1
from openstl.utils import reduce_tensor
from .base_method import Base_method


class SVPmovinglstm1(Base_method):
    r"""SimVP
    ...
    def _build_model(self, args):
        return SimVP_Modelmovinglstm1(**args).to(self.device)
