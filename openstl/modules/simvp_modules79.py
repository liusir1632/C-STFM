...
class EMA(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("x_w1.shape", x_w.shape)       #  torch.Size([10, 1024, 1, 22])
        ...
        # print("x_w2.shape", x_w.shape)          # torch.Size([10, 1024, 2, 22])
        x_w = x_w.permute(0, 2, 3, 1)
        # print("x_w3.shape", x_w.shape)          # torch.Size([10, 2, 22, 1024])
        x_w = self.conv_T(x_w)
        # print("x_w4.shape", x_w.shape)          # torch.Size([10, 1, 22, 1024])
        x_w = x_w.permute(0, 3, 2, 1)
        # print("x_w5.shape", x_w.shape)          # torch.Size([10, 1024, 22, 1])
        
        
        # 使用 时间 注意修饰输入
        x1 = self.gn(group_x * x_w.permute(0, 1, 3, 2).sigmoid()) 
