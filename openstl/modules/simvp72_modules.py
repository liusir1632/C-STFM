...
class GASubBlock(nn.Module):
    ...
    def __init__(self, dim, kernel_size=21, mlp_ratio=4.,
        ...
        self.drop_path_tau = DropPath(drop_path) if drop_path > 0. else nn.Identity()
        self.drop_path_sau = DropPath(0.) if drop_path > 0. else nn.Identity()
        self.drop_path_tcn = DropPath(0.) if drop_path > 0. else nn.Identity()
