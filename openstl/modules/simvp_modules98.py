...
class EMA(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("temp.shape", x.shape)          # torch.Size([1, 192, 16, 16])       (B, T*C, H, W)
...
class GASubBlock(nn.Module):
    ...
    def __init__(self, dim, kernel_size=21, mlp_ratio=4.,
        ...
        # SVP53_same_layer_small.py     1e-3
        self.init_value1 = 1e-3
        self.layer_scale_1 = nn.Parameter(self.init_value1 * torch.ones((dim)), requires_grad=True)
