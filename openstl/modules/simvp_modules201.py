...
class GASubBlock(nn.Module):
    ...
    def __init__(self, dim, kernel_size=21, mlp_ratio=4.,
                 drop=0., drop_path1=0.1, drop_path2=0.4, init_value=1e-2, act_layer=nn.GELU):
        super().__init__()
        ...
        self.drop_path2 = DropPath(drop_path2)    # SAFM使用  
        self.drop_path1 = DropPath(drop_path1) if drop_path1 > 0. else nn.Identity()    # mlp使用
