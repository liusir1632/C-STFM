...
class EMA(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("x1.shape", x.shape)          # torch.Size([10, 264, 32, 32])
        ...
        # print("x_h.shape", x_h.shape)               # torch.Size([10, 1024, 12, 1])
        ...
        # print("x_h2.shape", x_h.shape)             # torch.Size([10, 1024, 12, 2])
        x_h = x_h.permute(0, 3, 2, 1)
        # print("x_h3.shape", x_h.shape)          # torch.Size([10, 2, 12, 1024])
        x_h = self.conv_C(x_h)
        # print("x_h4.shape", x_h.shape)          # torch.Size([10, 1, 12, 1024])
        x_h = x_h.permute(0, 3, 2, 1)
        # print("x_h5.shape", x_h.shape)          # torch.Size([10, 1024, 12, 1])
        ...
        # print("x1.shape", x1.shape)                 # torch.Size([10, 264, 32, 32])
