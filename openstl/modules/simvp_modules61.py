...
class EMA(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("temp.shape", temp.shape)          # torch.Size([1, 96, 32, 32])
        ...
        # print("x_w.shape", x_w.shape)               # torch.Size([10, 1024, 22, 1])
        ...
        x2 = self.dw_conv(self.conv(temp)) # 通过 大核 卷积提取局部上下文信息: (B*G,C/G,H,W)-->(B*G,C/G,H,W)
