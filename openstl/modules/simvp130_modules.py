...
class GASubBlock(nn.Module):
    ...
    def __init__(self, dim, kernel_size=21, mlp_ratio=4.,
        ...
        self.hid = TCN(input_size=int(self.dim/12), output_size=int(self.dim/12), num_channels=[int(self.dim/12), int(self.dim/12)], kernel_size=3, dropout=drop)
    ...
    def forward(self, x):
        ...
        x = x + self.drop_path(self.layer_scale_3.unsqueeze(-1).unsqueeze(-1) * self.spat_atten(self.norm3(x)))
