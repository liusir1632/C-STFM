...
class SimVP_Model65(nn.Module):
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        super(SimVP_Model65, self).__init__()
...
class InceptionEncoder(nn.Module):
    def __init__(self,C_in,C_hid):
      ...
      self.enc2 = nn.Conv2d(C_in, C_hid, kernel_size=5, stride=1, padding=2, dilation=1)
      self.enc3 = nn.Conv2d(C_in, C_hid, kernel_size=7, stride=1, padding=3, dilation=1)
