...
class ConvLSTM4_Model(nn.Module):
    r"""ConvLSTM Model
    ...
    def __init__(self, num_layers, num_hidden, configs, **kwargs):
        super(ConvLSTM4_Model, self).__init__()
    ...
    def forward(self, frames_tensor, mask_true, **kwargs):
        ...
        for t in range(self.configs.pre_seq_length + self.configs.aft_seq_length - 1):
            ...
            x_gen = self.conv_last(h_t[self.num_layers - 1])      # 这里的 x_gen 的shape应该是 [B, 64, 8, 8]
            
            x_gen = self.next_deal(x_gen)
