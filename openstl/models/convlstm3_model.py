...
from openstl.modules.layers import ConditionTime

class ConvLSTM3_Model(nn.Module):
    r"""ConvLSTM Model
    ...
    def __init__(self, num_layers, num_hidden, configs, **kwargs):
        super(ConvLSTM3_Model, self).__init__()
        ...
        self.ct = ConditionTime(12)

    def forward(self, frames_tensor, mask_true, **kwargs):
        # 传进来的 frames_tensor 是分过patch的, 应该是[batch, length, height, width, channel]  [batch, 23, 8, 8, 64]
