...
from openstl.modules.simvp_modules98 import GASubBlock


class SimVP_Model98(nn.Module):
    r"""SimVP Model
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        super(SimVP_Model98, self).__init__()
    ...
    def forward(self, x_raw, **kwargs):
        ...
        # print("embed.shape",embed.shape)        # torch.Size([12, 16, 16, 16])
