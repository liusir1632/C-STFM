...
class ConvLSTM1_Model(nn.Module):
    r"""ConvLSTM Model
    ...
    def __init__(self, num_layers, num_hidden, configs, **kwargs):
        super(ConvLSTM1_Model, self).__init__()
        ...
        self.position_embedding = AxialPositionalEmbedding(dim = 64, shape = (8, 8))
    ...
    def forward(self, frames_tensor, mask_true, **kwargs):
        ...
        for t in range(seq_len):
            ...
            cur_input = self.next_deal(cur_input)       # torch.Size([B, 64, 8, 8])
