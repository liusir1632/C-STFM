...
class SimVP_Modelmovinglstm1(nn.Module):
    r"""SimVP Model
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        super(SimVP_Modelmovinglstm1, self).__init__()
        ...
        self.lstm = nn.LSTM(C, self.hidden_size, batch_first=True, bidirectional=True)
