...
from openstl.modules.simvp130_modules import TAUSubBlock

class SimVP130_Model(nn.Module):
    r"""SimVP Model
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        super(SimVP130_Model, self).__init__()
        ...
        self.norm = nn.GroupNorm(2, 2*self.hidden_size)
    ...
    def forward(self, x_raw, **kwargs):
        ...
        # print("lstm 后",x.shape)    # torch.Size([768, 96, 64, 64])
