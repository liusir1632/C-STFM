...
from openstl.modules.convlstm7_modules import ConvLSTM7_Cell


class ConvLSTM7_Model(nn.Module):
    r"""ConvLSTM Model
    ...
    def __init__(self, num_layers, num_hidden, configs, **kwargs):
        super(ConvLSTM7_Model, self).__init__()
        ...
        for i in range(num_layers):
            ...
            cell_list.append(
                ConvLSTM7_Cell(in_channel, num_hidden[i], height, width, configs.filter_size,
