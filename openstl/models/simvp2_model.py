...
class SimVP2_Model(nn.Module):
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
                 ...
                 spatio_kernel_dec=3, act_inplace=True, hidden_size=8,**kwargs):
        super(SimVP2_Model, self).__init__()
        ...
        self.hidden_size = hidden_size
        self.lstm = nn.LSTM(C, hidden_size, batch_first=True, bidirectional=True)
