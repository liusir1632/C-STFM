...
from openstl.modules.simvp57_modules import TAUSubBlock

class SimVP57_Model(nn.Module):
    r"""SimVP Model
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
                 ...
                 spatio_kernel_dec=3, act_inplace=True, hidden_size=48,**kwargs):
        super(SimVP57_Model, self).__init__()
    ...
    def forward(self, x_raw, **kwargs):
        ...
        # print("x2.shape", x2.shape)     # torch.Size([43008, 12, 1])
        
        x3, _ = self.lstm(x2)
        
        # print(x3.shape)   # ([4096, 12, 64])
...
class MidMetaNet(nn.Module):
    ...
    def __init__(self, channel_in, channel_hid, N2,
        ...
        dpr = [  # stochastic depth decay rule
            x.item() for x in torch.linspace(5e-3, drop_path, self.N2)]
